            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'cat_id',
                  $options,
                  set_value( 'cat_id', show_data( @$disable->cat_id), false ),
            ...
            <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    'deal_option_id',
                    $options,
                    set_value( 'deal_option_id', show_data( @$disable->deal_option_id), false ),
              ...
              <?php
                if(isset($item)) {
                  ...
                  echo form_dropdown(
                    'sub_cat_id',
                    $options,
                    set_value( 'sub_cat_id', show_data( @$disable->sub_cat_id), false ),
