<div class="table-responsive animated fadeInRight">
	...
	<?php if ( !empty( $business_users ) && count( $business_users->result()) > 0 ): ?>

		<?php foreach($business_users->result() as $business_user): ?>
			
			<tr>
				<td><?php echo ++$count;?></td>
				<td ><?php echo $business_user->name;?></td>
				<td ><?php echo $business_user->email;?></td>
				<td ><?php echo $business_user->phone;?></td>
