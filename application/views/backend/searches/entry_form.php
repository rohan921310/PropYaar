<?php
	$attributes = array( 'id' => 'indraft-form', 'enctype' => 'multipart/form-data');
      ...
      <div class="card-body">
      	<div class="row">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'title',
                'value' => set_value( 'title', show_data( @$indraft->title), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'cat_id',
                  $options,
                  set_value( 'cat_id', show_data( @$indraft->cat_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_type_id',
                  $options,
                  set_value( 'item_type_id', show_data( @$indraft->item_type_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_location_id',
                  $options,
                  set_value( 'item_location_id', show_data( @$indraft->item_location_id), false ),
            ...
            <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    'deal_option_id',
                    $options,
                    set_value( 'deal_option_id', show_data( @$indraft->deal_option_id), false ),
            ...
            <div class="form-group">
              ...
              <?php echo form_textarea( array(
                'name' => 'description',
                'value' => set_value( 'description', show_data( @$indraft->description), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php echo form_textarea( array(
                'name' => 'highlight_info',
                'value' => set_value( 'info', show_data( @$indraft->highlight_info), false ),
                'class' => 'form-control form-control-sm',
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'price',
                'value' => set_value( 'price', show_data( @$indraft->price), false ),
                'class' => 'form-control form-control-sm',
              ...
              <?php
                if(isset($item)) {
                  ...
                  echo form_dropdown(
                    'sub_cat_id',
                    $options,
                    set_value( 'sub_cat_id', show_data( @$indraft->sub_cat_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_price_type_id',
                  $options,
                  set_value( 'item_price_type_id', show_data( @$indraft->item_price_type_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'item_currency_id',
                  $options,
                  set_value( 'item_currency_id', show_data( @$indraft->item_currency_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  $options,
                  set_value( 'condition_of_item_id', show_data( @$indraft->condition_of_item_id), false ),
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'brand',
                'value' => set_value( 'brand', show_data( @$indraft->brand), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'business_mode',
                  'value' => 'accept',
                  'checked' => set_checkbox('business_mode', 1, ( @$indraft->business_mode == 1 )? true: false ),
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'is_sold_out',
                  'value' => 'accept',
                  'checked' => set_checkbox('is_sold_out', 1, ( @$indraft->is_sold_out == 1 )? true: false ),
                  'class' => 'form-check-input',
                  'onclick' => 'return false'
                )); ?>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo form_textarea( array(
                'name' => 'address',
                'value' => set_value( 'address', show_data( @$indraft->address), false ),
                'class' => 'form-control form-control-sm',
          ...
          <?php if (  @$indraft->lat !='0' && @$indraft->lng !='0' ):?>
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php 
                echo form_input( array(
                  ...
                  'class' => 'form-control',
                  'placeholder' => '',
                  'value' => set_value( 'lat', show_data( @$indraft->lng ), false ),
                  'readonly' => 'true'
                ));
              ?>
            </div>
