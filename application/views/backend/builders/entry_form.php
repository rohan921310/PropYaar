	            	...
	            	<div class="col-md-12">
	            		<div class="form-group">
							...
							<?php echo form_input( array(
								'name' => 'name',
								'value' => set_value( 'name', show_data( @$builders->name ), false ),
						...
						<div class="form-group">
							...
							<?php echo form_input( array(
								'name' => 'phone_number',
								'value' => set_value( 'phone_number', show_data( @$builders->phone_number ), false ),
								'class' => 'form-control form-control-sm',
						...
						<div class="form-group">
							...
							<?php echo form_input( array(
								'name' => 'location',
								'value' => set_value( 'location', show_data( @$builders->location ), false ),
								'class' => 'form-control form-control-sm',
						...
						<div class="form-group">
                           ...
                           <?php echo form_textarea(array(
                              'name' => 'info',
                              'value' => set_value('info', show_data(@$builders->info), false),
                              'class' => 'form-control form-control-sm',
						...
						<div class="form-group">
                           ...
                           <select name="rating" class="form-control">
                              <?php if (empty($builders->rating)) { ?>
                              <option value="">Select Rating</option>
                              <?php } ?>
                              <option value="0" 
                                 <?php if ($builders->rating == "0") {
                                    echo "selected";
                                    } ?>>0
                              </option>
                              <option value="1" 
                                 <?php if ($builders->rating == "1") {
                                    echo "selected";
                                    } ?>>1
                              </option>
                              <option value="2" 
                                 <?php if ($builders->rating == "2") {
                                    echo "selected";
                                    } ?>>2
                              </option>
                              <option value="3" 
                                 <?php if ($builders->rating == "3") {
                                    echo "selected";
                                    } ?>>3
                              </option>
							  <option value="4" 
                                 <?php if ($builders->rating == "4") {
                                    echo "selected";
                                    } ?>>4
                              </option>
							  <option value="5" 
                                 <?php if ($builders->rating == "5") {
                                    echo "selected";
                                    } ?>>5
                              </option>
                           </select>
						...
						<div class="form-group" >
                             <div class="form-check">
                              ...
                              <?php echo form_checkbox(array(
                                 ...
                                 'id' => 'is_open',
                                 'value' => 'accept',
                                 'checked' => set_checkbox('is_open', 1, (@$builders->is_open == 1) ? true : false),
                                 'class' => 'form-check-input'
                                 )); ?>
						...
						<div class="form-group" >
                             <div class="form-check">
                              ...
                              <?php echo form_checkbox(array(
                                 ...
                                 'id' => 'is_like',
                                 'value' => 'accept',
                                 'checked' => set_checkbox('is_like', 1, (@$builders->is_like == 1) ? true : false),
                                 'class' => 'form-check-input'
                                 )); ?>
