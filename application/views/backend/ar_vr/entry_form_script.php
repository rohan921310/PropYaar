<script>
		...
		$('#category-form').validate({
			rules:{
				cat_name:{
					blankCheck : "",
					minlength: 3,
					remote: "<?php echo $module_site_url .'/ajx_exists/'.@$arvr_data->id; ?>"
				},
				images1:{
					required: true
				},
	...
	function runAfterJQ() {
		...
		$('.delete-img').click(function(e){
			...
			// do action
			var action = '<?php echo $module_site_url .'/delete_cover_photo/'; ?>' + id + '/<?php echo @$arvr_data->id; ?>';
			console.log( action );
