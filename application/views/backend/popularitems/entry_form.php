        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  'class="form-control form-control-sm mr-3" disabled="disabled" id="popularitem_location_id"'
                );
              ?>
            </div>
            ...
            <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    'deal_option_id',
                    $options,
                    set_value( 'deal_option_id', show_data( @$popularitem->deal_option_id), false ),
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  'class="form-control form-control-sm mr-3" disabled="disabled" id="popularitem_price_type_id"'
                );
              ?>
            </div>
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  'class="form-control form-control-sm mr-3" disabled="disabled" id="popularitem_currency_id"'
                );
              ?>
            </div>
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  $options,
                  set_value( 'condition_of_popularitem_id', show_data( @$popularitem->condition_of_item_id), false ),
                  'class="form-control form-control-sm mr-3" disabled="disabled" id="condition_of_popularitem_id"'
                );
              ?>
            </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'brand',
                'value' => set_value( 'brand', show_data( @$popularitem->brand), false ),
                'class' => 'form-control form-control-sm',
           ...
           <!--  <label><?php echo get_msg('deal_option_id_label')?></label><br>
              ...
              <?php if (isset($popularitem->deal_option_id) && $popularitem->deal_option_id=="1") echo "checked";?>
              value="1"><?php echo get_msg('meet_up_label');?>
              <input type="radio" name="deal_option_id"
              <?php if (isset($popularitem->deal_option_id) && $popularitem->deal_option_id=="2") echo "checked";?>
          ...
          <div class="col-md-6">
            <div id="us3" style="width: 100%; height: 300px; pointer-events: none;"></div>
