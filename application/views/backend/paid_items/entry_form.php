            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  'class="form-control form-control-sm mr-3" '.$disabled.' id="cat_id"'
                );
              ?>
            </div>
            ...
            <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="deal_option_id"'
                  );
                ?>
            </div>
              ...
              <?php
                if(isset($item)) {
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="sub_cat_id"'
                  );
