<script>
		...
		$('#condition-form').validate({
			rules:{
				name:{
					blankCheck : "",
					minlength: 3,
					remote: "<?php echo $module_site_url .'/ajx_exists/'.@$click_earn->id; ?>"
				}
			},
			messages:{
				name:{
	...
	function runAfterJQ() {
        ...
        $('.delete-img').click(function(e){
        	...
        	// do action
        	var action = '<?php echo $module_site_url .'/delete_cover_photo/'; ?>' + id + '/<?php echo @$click_earn->id; ?>';
        	console.log( action );
