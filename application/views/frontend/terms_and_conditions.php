...
<!-- Mirrored from storage.googleapis.com/theme-vessel/neer/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jul 2020 17:55:48 GMT -->
<head>
    <!-- Google Tag Manager -->
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <div class="about-info">
                    <img class="d-block w-100" src="<?php echo base_url()?>/assets/img/properties/properties-6.jpg" alt="Third slide">
            ...
            <div class="row slick-carousel" data-slick='{"slidesToShow": 4, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                <div class="slick-slide-item">
                    <div class="team-1">
                        <div class="team-photo">
                            <a href="#">
                                <img src="<?php echo base_url()?>/assets/img/avatar/avatar-7.jpg" alt="agent-2" class="img-fluid">
                            </a>
                ...
                <div class="slick-slide-item">
                    <div class="team-1">
                        <div class="team-photo">
                            <a href="#">
                                <img src="<?php echo base_url()?>/assets/img/avatar/avatar-6.jpg" alt="agent-2" class="img-fluid">
                            </a>
                            <ul class="social-list clearfix">
                                <li><a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="#" class="twitter-bg"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="slick-slide-item">
                    <div class="team-1">
                        <div class="team-photo">
                            <a href="#">
                                <img src="<?php echo base_url()?>/assets/img/avatar/avatar-5.jpg" alt="agent-2" class="img-fluid">
                            </a>
                            <ul class="social-list clearfix">
                                <li><a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="#" class="twitter-bg"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="slick-slide-item">
                    <div class="team-1">
                        <div class="team-photo">
                            <a href="#">
                                <img src="<?php echo base_url()?>/assets/img/avatar/avatar-8.jpg" alt="agent-2" class="img-fluid">
                            </a>
                            <ul class="social-list clearfix">
                                <li><a href="#" class="facebook-bg"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="#" class="twitter-bg"><i class="fa fa-twitter"></i></a></li>
...
<!-- Testimonial start -->
<div class="testimonial testimonial-2 t4 content-area-5 bg-grea-3">
    <div class="container">
        <div class="row">
                    ...
                    <div class="row slick-carousel" data-slick='{"slidesToShow": 2, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                        <div class="slick-slide-item">
                            <div class="testimonial-info-box">
                                <div class="profile-user">
                                    <div class="avatar">
                                        <img src="<?php echo base_url()?>/assets/img/avatar/avatar-1.jpg" alt="testimonial-2">
                                    </div>
                                </div>
                                <h5>
                        ...
                        <div class="slick-slide-item">
                            <div class="testimonial-info-box">
                                <div class="profile-user">
                                    <div class="avatar">
                                        <img src="<?php echo base_url()?>/assets/img/avatar/avatar-3.jpg" alt="testimonial-2">
                                    </div>
                                </div>
                                <h5>
                        ...
                        <div class="slick-slide-item">
                            <div class="testimonial-info-box">
                                <div class="profile-user">
                                    <div class="avatar">
                                        <img src="<?php echo base_url()?>/assets/img/avatar/avatar-2.jpg" alt="testimonial-2">
                                    </div>
                                </div>
                                <h5>
    ...
    <div class="container">
        <div class="slick-slider-area">
            <div class="row slick-carousel" data-slick='{"slidesToShow": 5, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 3}}, {"breakpoint": 768,"settings":{"slidesToShow": 2}}]}'>
                <div class="slick-slide-item"><img src="<?php echo base_url()?>/assets/img/brand/brand-1.png" alt="brand" class="img-fluid"></div>
                <div class="slick-slide-item"><img src="<?php echo base_url()?>/assets/img/brand/brand-2.png" alt="brand" class="img-fluid"></div>
                <div class="slick-slide-item"><img src="<?php echo base_url()?>/assets/img/brand/brand-3.png" alt="brand" class="img-fluid"></div>
                <div class="slick-slide-item"><img src="<?php echo base_url()?>/assets/img/brand/brand-4.png" alt="brand" class="img-fluid"></div>
                <div class="slick-slide-item"><img src="<?php echo base_url()?>/assets/img/brand/brand-1.png" alt="brand" class="img-fluid"></div>
                <div class="slick-slide-item"><img src="<?php echo base_url()?>/assets/img/brand/brand-2.png" alt="brand" class="img-fluid"></div>
                <div class="slick-slide-item"><img src="<?php echo base_url()?>/assets/img/brand/brand-3.png" alt="brand" class="img-fluid"></div>
                <div class="slick-slide-item"><img src="<?php echo base_url()?>/assets/img/brand/brand-4.png" alt="brand" class="img-fluid"></div>
...
<!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
<script  src="<?php echo base_url() ?>/assets/js/js/ie10-viewport-bug-workaround.js "></script>
<!-- Custom javascript -->
<script  src="<?php echo base_url() ?>/assets/js/js/ie10-viewport-bug-workaround.js "></script>
</body>
