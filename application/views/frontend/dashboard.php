                        ...
                        <div class="col-sm-12 col-md-7">
                            <div class="breadcrumb-nav">
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?php echo base_url(); ?>dashboard" class="active">Dashboard</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                            <div class="comment">
                                                <div class="comment-author">
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>assets/frontend/img/avatar/avatar-3.jpg" alt="comments-user">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="comment">
                                                <div class="comment-author">
                                                    <a href="#"><img src="<?php echo base_url(); ?>assets/frontend/img/avatar/avatar-1.jpg" alt="comments-user"></a>
                                                </div>
                                                <div class="comment-content">
                                                    <div class="comment-meta">
                                                        <h5>
                                            ...
                                            <div class="comment mb-0">
                                                <div class="comment-author">
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>assets/frontend/img/avatar/avatar-2.jpg" alt="comments-user">
                                                    </a>
                                                </div>
                                                <div class="comment-content">
                                                    <div class="comment-meta">
                                        ...
                                        <div class="tab-pane fade active show" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                            ...
                                            <div class="comment mb-0">
                                                <div class="comment-author">
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>assets/frontend/img/avatar/avatar-1.jpg" alt="comments-user">
                                                    </a>
                                                </div>
                                                <div class="comment-content">
                                                    <div class="comment-meta">
