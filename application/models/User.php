...
class User extends PS_Model {
	...
	function custom_conds( $conds = array())
	{
		...
		// overall_rating condition
		if ( isset( $conds['user_whatsapp_number'] )) {
			$this->db->where( 'user_whatsapp_number',$conds['user_whatsapp_number'] );
		}
	...
	function has_permission( $module_id, $user_id )
	{
		...
		$this->db->where( $this->module_table_name .'.module_lang_key', $module_id );
		$query = $this->db->get();
	...
	function get_device_token($user_phone)
	{
