 ...
 */
class Business extends BE_Controller {
	...
	function __construct() {
		...
		parent::__construct( MODULE_CONTROL, 'business_users_module' );
	}
	...
	function index() {
		...
		// get rows count
		$this->data['rows_count'] = $this->Business_modal->count_all_by( $conds );
		
		// get categories
		$this->data['business_users'] = $this->Business_modal->get_all_by( $conds , $this->pag['per_page'], $this->uri->segment( 4 ) );
		// load index logic
		parent::index();
	}
...
//
//		// load user
//		$this->data['category'] = $this->Business_modal->get_one( $id );
//
...
//
//		// save category
//		if ( ! $this->Business_modal->save( $data, $id )) {
