 ...
 * REST API for News
 */
class News_categories extends API_Controller
{
	...
	function default_conds()
	{
		...
		// if is get record using GET method
			...
			$setting = $this->Api->get_one_by( array( 'api_constant' => GET_ALL_NEWS_CATEGORIES ));
	...
	function convert_object( &$obj )
	{
		...
		$this->ps_adapter->convert_news_category( $obj );
	}
